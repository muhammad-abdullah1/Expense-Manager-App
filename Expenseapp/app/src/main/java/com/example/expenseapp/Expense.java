...
private String title;
    ...
    // Constructor for personal expenses (defaults to "Other" category)
    ...
    // Constructor for personal expenses with a category
    public Expense(String id, String description, double amount, String date, String category) {
        this.id = id;
        this.description = description;
        this.amount = amount;
        this.date = date;
